...
// Define the TypeScript interface for Booking
interface Booking {
  id: number;
  customerId: number;
  listingId: number;
  ...
  unitId: number;
  bookingDates: string[]; // Array of check-in and check-out dates
  status: string;
  createdAt: string;
  paymentDetails: {
    method: string;
...
export default function CustomerBookings() {
  ...
  const customerId = searchParams.get("customerId"); // Extract customerId from query params
